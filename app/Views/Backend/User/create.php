...
<div class="row">
    <div class="col-md-12">
        <div class="card card-outline card-info">
            ...
            <div class="card-body">
                <form action="<?= route_to('admin.user.create') ?>" method="post" class="form-horizontal">
                    <?= csrf_field() ?>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <select class="form-control select" name="active" style="width: 100%;">
                                <option value="1" selected="selected"><?= lang('Haoadmin.user.fields.active') ?></option>
                                <option value="0"><?= lang('Haoadmin.user.fields.non_active') ?></option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <?php foreach ($roles as $role) { ?>
                                <option <?= in_array($role['description'], old('role', [])) ? 'selected' : '' ?> value="<?= $role['title'] ?>"><?= $role['description'] ?></option>
                            <?php } ?>
                            </select>
