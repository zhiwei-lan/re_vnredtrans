        ...
        <div class="card card-primary card-outline">
            <div class="card-body box-profile">
                <div class="text-center">
                    <img class="profile-user-img img-fluid img-circle" src="/assets/lib/backend/avatar.jpg"
                ...
                <ul class="list-group list-group-unbordered mb-3">
                    <li class="list-group-item">
                        <b><?= lang('Haoadmin.user.fields.join') ?></b> 
                        <a class="float-right">
        ...
        <div class="card card-outline">
            <div class="card-header p-2">
                <ul class="nav nav-pills">
                    <li class="nav-item"><a class="nav-link active" href="#settings" data-toggle="tab"><?= lang('Haoadmin.user.fields.setting') ?></a></li>
                </ul>
            </div><!-- /.card-header -->
            <div class="card-body">
