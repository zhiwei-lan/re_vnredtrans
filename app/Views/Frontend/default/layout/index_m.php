...
<html lang="<?= esc($locale) ?>">
	<head>
		<meta charset="utf-8">
		<meta name="viewport" content="width=750, user-scalable=no, maximum-scale=1, initial-scale=1.0">
		<script>
		(function() {
		  var scale = window.screen.width / 750;
		  var meta = document.querySelector('meta[name="viewport"]');
		  if (meta) {
		    meta.setAttribute('content', 'width=750, initial-scale=' + scale + ', maximum-scale=' + scale + ', user-scalable=no');
		  }
		})();
		</script>
	...
	<body class="vietnam">
		<!-- Header -->
        <?= $this->include('Frontend/default/layout/header_m') ?>

        <!-- Content -->
		<?= $this->renderSection('content') ?>

        <!-- Footer -->
        <?= $this->include('Frontend/default/layout/footer_m') ?>
		...
		<script src="/assets/lib/jquery-scrolla-master/src/scrolla.jquery.js"></script>
		<script src="/assets/js/haodesign-script-m.js"></script>
