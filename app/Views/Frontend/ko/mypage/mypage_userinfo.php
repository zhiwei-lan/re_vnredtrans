            ...
            <div class="cont">
                ...
                <div class="user-info">
                    ...
                    <div class="bass-info">
                        ...
                        <div class="bd"><?php echo $singleUser['phone']?></div>
                    </div>
                </div>
                <div class="detail-info">
                    <form id="user_info">
                        ...
                        <div class="info">
                            ...
                            <div class="form-group">
                                <label>연락처</label>
                                <input type="text" name="user_phone" id="userphone" value="<?php echo $singleUser['phone']?>">
                            </div>
                            <!-- <div class="form-group">
                                <label>이메일 주소</label>
                                <input type="text" name="user_email" id="user_email" value="<?php echo $singleUser['phone']?>">
                            </div> -->
                        </div>
                        <div class="btn">
