        ...
        <div class="container">
            <div class="cont">
                ...
                <div class="detail-info">
                    <form id="user_info">
                    <input type="hidden" name="user_index" id="user_index" value="<?php echo $singleUser['user_index']?>">
                        <div class="info">
                            <div class="form-group">
                                <label>이름</label>
                                <input type="text" name="user_name" id="user_name" value="<?php echo $singleUser['user_name']?>">
                            </div>
                            <div class="form-group">
                                <label>연락처</label>
                                <input type="text" name="user_phone" id="user_phone" value="<?php echo $singleUser['user_phone']?>">
                            </div>
                            <div class="form-group">
                                <label>이메일 주소</label>
                                <input type="text" name="user_email" id="user_email" value="<?php echo $singleUser['user_email']?>">
                            </div>
                        </div>
                        <div class="btn">
