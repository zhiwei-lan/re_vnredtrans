...
<?= view('Frontend/default/swiper/swiper_home', [
    ...
    'config' => $main_top_banner['config']??[],
        ...
        <div class="group">
            <a href="/ko/pages/vn_company" class="item hot">
                <div class="icon">
                    <img src="/assets/images/vitenam_07.png">
                </div>
                <div class="txt">베트남<br>회사 설립</div>
            </a>
            <a href="/ko/pages/cosmetics" class="item hot">
                <div class="icon">
            ...
            <a href="/ko/pages/vn_translation1" class="item ">
                <div class="icon">
                    <img src="/assets/images/vitenam_05.png">
                </div>
                <div class="txt">베트남<br>번역</div>
            </a>
            <a href="#" class="item">
                <div class="icon">
    ...
    <div class="item-15 container">
            ...
            <div class="owl-stage-outer">
              <div class="owl-stage">
                ...
                <div class="owl-item">
                  <div class="item">
                    <div class="avatar">
                      <img src="<?= base_url($customer['thumbnail']??'assets/lib/haocms/frontend/images/default_images.png')?>">
                    </div>
                    <div class="cate"><?php echo $customer['default_subject']?></div>
                    <div class="name"><?php echo $customer['default_title']?></div>
                    <div class="description">
                      <?php echo $customer['default_description']?>
                    </div>
                    <a href="/ko/article/<?= $customer['category_id'] ?>/review">자세히 보기<i></i></a>
                  </div>
                </div>
                <?php endforeach;?>
              </div>
        ...
        <div class="container row-flex">
                    ...
                    <div class="owl-carousel owl-theme owl-loaded">
                        <div class="owl-stage-outer">
                            <div class="owl-stage">
                                ...
                                <div class="owl-item">
                                    <img src="/assets/images/redtrans_main_146.png">
                                </div>
                                <div class="owl-item">
                                    <img src="/assets/images/redtrans_main_148.png">
                                </div>
                                <div class="owl-item">
                                    <img src="/assets/images/redtrans_main_150.png">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="pdf">
                <div class="btn"><a ><img src="/assets/images/redtrans_main_132.png"></a></div>
                <div class="btn"><a ><img src="/assets/images/redtrans_main_135.png"></a></div>
                <img src="/assets/images/redtrans_main_130.png">
            </div>
        </div>
    </div>
<?= $this->endSection() ?>	
