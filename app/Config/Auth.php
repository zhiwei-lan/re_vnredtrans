...
class Auth extends ShieldAuth
{
    ...
    public function __construct()
    {
        ...
        $this->redirects = [
            'register'          => "/$locale/mypage/services",
            'login'             => "/$locale/mypage/userinfo",
            'logout'            => "/$locale/phone/login",
            'force_reset'       => "/$locale/",
            'permission_denied' => "/$locale/",
            'group_denied'      => "/$locale/",
        ];
    }
     ...
     */
    public array $views = [
        'login'                       => '\App\Views\Frontend\default\auth\login_by_email',
        'register'                    => '\App\Views\Frontend\default\auth\register',
        'layout'                      => '\CodeIgniter\Shield\Views\layout',
        'action_email_2fa'            => '\CodeIgniter\Shield\Views\email_2fa_show',
        'action_email_2fa_verify'     => '\CodeIgniter\Shield\Views\email_2fa_verify',
        'action_email_2fa_email'      => '\CodeIgniter\Shield\Views\Email\email_2fa_email',
        'action_email_activate_show'  => '\App\Views\Frontend\default\auth\email_check',
        'action_email_activate_email' => '\CodeIgniter\Shield\Views\Email\email_activate_email',
        'magic-link-login'            => '\App\Views\Frontend\default\auth\find_pw',
        'magic-link-message'          => '\App\Views\Frontend\default\auth\magic_link',
    ...
    public array $redirects = [
        'register'          => '/mypage/services',
        'login'             => '/mypage/userinfo',
        'logout'            => '/phone/login',
        'force_reset'       => '/',
        'permission_denied' => '/',
        'group_denied'      => '/',
    ...
    public array $actions = [
        'register' => null,//\CodeIgniter\Shield\Authentication\Actions\EmailActivator::class, //email验证
        'login'    => null,
    ];
